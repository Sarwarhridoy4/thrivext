...
```
অনেক সময় `ternary` এবং `nullish coalescing` অপারেটর একইরকম মনে হলেও তারা আসলে এক নয়। নিচে একটা উদাহরণ দেখ:

```tsx
const isAuthenticated = '';
const user = isAuthenticated ?? "Guest";
// ✅ শুধু null বা undefined হলে fallback হবে
const user2 = isAuthenticated ? isAuthenticated : "Guest";
// ❌ এখানে '' কে falsy ধরে fallback হবে না
```

উপরে আমরা দেখতে পারি `''` (empty string) যেটার কোনো value নাই, সেই ক্ষেত্রে `user` (nullish operator) "Guest" রিটার্ন করে, কিন্তু `user2` (ternary operator) empty string রিটার্ন করে।

অর্থাৎ, ternary operator `''`, `0`, `false`—এই সব falsy value-কে `null` বা `undefined` হিসেবে দেখে না। এজন্য ঠিকভাবে যাচাই না করলে এতে অনেক সমস্যা হতে পারে।

---

📌 **সারাংশে:**

| ভ্যালু | `??` fallback করে? | `?:` fallback করে? |
| --- | --- | --- |
| `null` | ✅ করে | ✅ করে (falsy) |
| `undefined` | ✅ করে | ✅ করে (falsy) |
| `false` | ❌ করে না | ✅ করে (falsy) |
| `''` (empty string) | ❌ করে না | ✅ করে (falsy) |
| `0` | ❌ করে না | ✅ করে (falsy) |
---
